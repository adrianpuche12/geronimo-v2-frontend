...
function App() {
  ...
  const handleCreateProject = async () => {
    ...
    try {
      ...
      showToast(
        parts.length > 0
          ? `Workspace "${projectName}" creado con ${parts.join(' y ')}.`
          : `Workspace "${projectName}" creado correctamente.`,
        'success'
      );
    } catch (error) {
  ...
  const handleUpdateProject = async () => {
    ...
    try {
      ...
      showToast(`Workspace "${editProjectName}" actualizado correctamente.`, 'success');
    } catch (error) {
    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          showToast(`Workspace "${project.name}" eliminado correctamente.`, 'success');
        } catch (error) {
