...
export const LeftRail = ({
  ...
  return (
    ...
    >
      ...
      {/* Guía de ayuda — link externo */}
      <a
        href="https://tester.iurivia.com/guia.html"
        target="_blank"
        rel="noopener noreferrer"
        className="rail-item"
        title="Centro de ayuda"
        style={{ textDecoration: 'none', color: 'var(--success, #34D399)', marginTop: '4px' }}
      >
        ...
        <span className="rail-item-label" style={{ color: 'var(--success, #34D399)' }}>Centro de ayuda</span>
      </a>
